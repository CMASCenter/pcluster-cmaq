...
#  -----------------------
   mkdir /proj/ie/proj/CMAS/CMAQ/CMAQv5.3.3/build-hdf5
...
#  ----------------------------------
   ...
   ./configure --prefix=/proj/ie/proj/CMAS/CMAQ/CMAQv5.3.3/build-hdf5/install MPIF77=mpif90 MPIF90=mpif90 MPICC=mpicc MPICXX=mpicxx --with-mpi=/nas/longleaf/apps/r/4.1.3/openmpi
   make |& tee make.gcc9.log
   make install
#  ----------------------------------------
...
# install test
   cd /proj/ie/proj/CMAS/CMAQ/CMAQv5.3.3/build-hdf5/install/bin
   whereis h5diff
   nc-config --version
   nf-config --version
