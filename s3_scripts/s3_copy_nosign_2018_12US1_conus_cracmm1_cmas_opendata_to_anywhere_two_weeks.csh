...
aws --no-sign-request s3 cp --recursive --exclude "*" --include "*201712*" --include "*20180101*" --include "*20180102*" --include "smk_merge_dates_201801.txt"  --include "smk_merge_dates_201712.txt" s3://cmas-cmaq-modeling-platform-2018/2018_12US1/emis /$DISK/data/CMAQ_Modeling_Platform_2018/2018_12US1/emis
