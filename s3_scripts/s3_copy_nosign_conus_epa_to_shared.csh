...
aws --no-sign-request s3 cp --recursive --exclude "*" --include "*151222*" --include "*151223*"  s3://edap-oar-data-commons/2016_Modeling_Platform/CMAQ_Input/BCON /$DISK/data/CONUS/12US2/icbc
