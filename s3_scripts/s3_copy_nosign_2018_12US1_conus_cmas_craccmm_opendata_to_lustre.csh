...
aws --no-sign-request s3 cp --recursive --exclude "*" --include "*stack_groups*" s3://cmas-cmaq-modeling-platform-2018/2018_12US1/emis/cb6r3_ae6_20200131_MYR/ /$DISK/data/CMAQ_Modeling_Platform_2018/2018_12US1/emis/cb6r3_ae6_20200131_MYR/
aws --no-sign-request s3 cp --recursive --exclude "*" --include "*20180715*" s3://cmas-cmaq-modeling-platform-2018/2018_12US1/emis/WR705_2018gc2_cracmmv1/cmaq_ready /$DISK/data/CMAQ_Modeling_Platform_2018/2018_12US1/emis/WR705_2018gc2_cracmmv1/cmaq_ready
aws --no-sign-request s3 cp --recursive --exclude "*" --include "*20180710*" s3://cmas-cmaq-modeling-platform-2018/2018_12US1/emis/WR705_2018gc2_cracmmv1/cmaq_ready /$DISK/data/CMAQ_Modeling_Platform_2018/2018_12US1/emis/WR705_2018gc2_cracmmv1/cmaq_ready
aws --no-sign-request s3 cp --recursive --exclude "*" --include "*20180715*" s3://cmas-cmaq-modeling-platform-2018/2018_12US1/emis/WR705_2018gc2_cracmmv1/premerged /$DISK/data/CMAQ_Modeling_Platform_2018/2018_12US1/emis/WR705_2018gc2_cracmmv1/premerged
aws --no-sign-request s3 cp --recursive --exclude "*" --include "*20180710*" s3://cmas-cmaq-modeling-platform-2018/2018_12US1/emis/WR705_2018gc2_cracmmv1/premerged /$DISK/data/CMAQ_Modeling_Platform_2018/2018_12US1/emis/WR705_2018gc2_cracmmv1/premerged
aws --no-sign-request s3 cp --recursive --exclude "*" --include "*20180709*" s3://cmas-cmaq-modeling-platform-2018/2018_12US1/emis/WR705_2018gc2_cracmmv1/premerged /$DISK/data/CMAQ_Modeling_Platform_2018/2018_12US1/emis/WR705_2018gc2_cracmmv1/premerged
aws --no-sign-request s3 cp --recursive --exclude "*" --include "*20180709*" s3://cmas-cmaq-modeling-platform-2018/2018_12US1/emis/WR705_2018gc2_cracmmv1/cmaq_ready /$DISK/data/CMAQ_Modeling_Platform_2018/2018_12US1/emis/WR705_2018gc2_cracmmv1/cmaq_ready
aws --no-sign-request s3 cp --recursive --exclude "*" --include "*20180701*" s3://cmas-cmaq-modeling-platform-2018/2018_12US1/emis/WR705_2018gc2_cracmmv1/cmaq_ready /$DISK/data/CMAQ_Modeling_Platform_2018/2018_12US1/emis/WR705_2018gc2_cracmmv1/cmaq_ready
aws --no-sign-request s3 cp --recursive --exclude "*" --include "*20180702*" s3://cmas-cmaq-modeling-platform-2018/2018_12US1/emis/WR705_2018gc2_cracmmv1/cmaq_ready /$DISK/data/CMAQ_Modeling_Platform_2018/2018_12US1/emis/WR705_2018gc2_cracmmv1/cmaq_ready
