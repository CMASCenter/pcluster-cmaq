...
mkdir -p /shared/data
setenv DISK shared
aws --no-sign-request s3 cp --recursive --exclude "*" --include "*151222" --include "*151223" s3://cmas-cmaq-conus2-benchmark/data/CMAQ_Modeling_Platform_2016/CONUS/12US2/MCIP /$DISK/data/CONUS/12US2/MCIP
aws --no-sign-request s3 cp --recursive --exclude "*" --include "*151222*" --include "*151223*" --include "smk_merge_dates_201512.txt" s3://cmas-cmaq-conus2-benchmark/data/CMAQ_Modeling_Platform_2016/CONUS/12US2/emissions /$DISK/data/CONUS/12US2/emissions
...
aws --no-sign-request s3 cp --recursive --exclude "*" --include "README.txt" s3://cmas-cmaq-conus2-benchmark/data/CMAQ_Modeling_Platform_2016/CONUS/12US2 /$DISK/data/CONUS/12US2
