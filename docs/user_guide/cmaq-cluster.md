...
1. [Compare timings and verify that the run completed successfully](../parse_timing)
2. [Run combine and post processing scripts](../post_combine)
3. [Run QA scripts](../qa_cmaq_run)
4. [Copy the output to the S3 Bucket](../copy_output_to_S3_Bucket)
5. Exit the cluster
