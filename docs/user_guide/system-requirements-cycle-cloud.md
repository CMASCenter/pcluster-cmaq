...
| ------------- | -----------    | -----------   | ----------------     | ---------------      | -------------------        | ------------------ | --------------          | ---------                              |   -------- | --------- | ------ | ---------------      |
| 120          |   1x120    |    10x12           | 2829.84              |  2516.07             |   5345.91                  |  no                | copied                  |  false                                 |            |                    |                      |             |
...
| 240          |   2x120    |   20x12            |  1856.50             | 1667.68                     |    3524.18                |  no                | copied                  |  false                                 |             |                               |                                     | without -march=native compiler flag |  
...
| 360           |  3x120     |  20x18             | 1520.29              |  1375.54             |    2895.83                 |  no                | copied                  |  false                  |   | ?/hr * 4 nodes * .804 = $? | 3.6/hr * 4 nodes * .804 = $11.59 | with -march=native compiler flag | 
