...
| 126            |  7x18          | 9x14         |               |               |                    |  yes         |  true               | yes                   |                      |    0.5971/hr * 7 node * ? hr= $?           | 1.944/hr * 7 node * ? hr = $? |
| 144            |  8x18          | 12x12        |               |               |                    |  yes         |  true               | yes                   |                      |    0.5971/hr * 8 node * ? hr= $?           | 1.944/hr * 8 node * ? hr = $? |
| 162            |  9x18          | 9x18        |               |               |                    |  yes         |  true               | yes                   |                      |    0.5971/hr * 9 node * ? hr= $?           | 1.944/hr * 9 node * ? hr = $? |
| 180            |  10x18          | 10x18        |               |               |                    |  yes         |  true               | yes                   |                   |    0.5971/hr * 10 node * ? hr= $?           | 1.944/hr * 10 node * ? hr = $? |
