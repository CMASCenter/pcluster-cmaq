...
| Number of PEs | #Nodesx#CPU | NPCOLxNPROW | Day1 Timing (sec) | Day2 Timing (sec) | Total Time(2days)(sec) | SBATCH --exclusive |  DisableSimultaneousMultithreading(yaml)| with -march=native | Answers Matched | Cost using Spot Pricing | Cost using On Demand Pricing |
| ------------- | -----------    | -----------   | ----------------     | ---------------      | -------------------        | ------------------ | --------------          | ---------                              |   -------- | --------- | ------ |
| 18            |  1x18          | 3x6           |  14341.77     | 12881.59 | 27223.36             |  yes         |  true               | yes                   |                      |    0.5971/hr * 1 node * 7.56 hr= $4.51         | 1.944/hr * 1 node * 7.56 hr = $14.69 |
| 36            |  2x18          | 6x6           |   6473.95     | 5599.76  |  12073.71               |  yes         |  true               | yes                   |                      |    0.5971/hr * 2 node * 3.35 hr= $4.0        | 1.944/hr * 2 node * 3.35 hr = $13.02 |
| 54            |  3x18          | 6x9           |   4356.33     | 3790.13  |  8146.46          |  yes         |  true               | yes                   |                      |    0.5971/hr * 3 node * 2.26 hr= $4.05           | 1.944/hr * 3 node * 2.26 hr = $13.2 |
| 72            |  4x18          | 8x9           |    3382.01    | 2936.66  |  6318.67        |  yes         |  true               | yes                   |                      |    0.5971/hr * 4 node * 1.755 hr= $4.19           | 1.944/hr * 4 node * 1.755 hr = $13.2 |
| 90            |  5x18          | 9x10          |    2878.55    |  2483.56 | 5362.11        |  yes         |  true               | yes                   |                      |    0.5971/hr * 5 node * 1.49 hr= $4.45           | 1.944/hr * 5 node * 1.49 hr = $14.44 |
| 108            |  6x18          | 9x12         |   2463.41     |2161.07        | 4624.48   |  yes         |  true               | yes                   |                      |    0.5971/hr * 6 node * 1.28 hr= $4.6           | 1.944/hr * 6 node * 1.28 hr = $14.9 |
| 126            |  7x18          | 9x14         | 2144.86     | 1897.85      | 4042.71                   |  yes         |  true               | yes                   |                      |    0.5971/hr * 7 node * 1.12 hr= $4.69           | 1.944/hr * 7 node * 1.12 hr = $15.24 |
| 144            |  8x18          | 12x12        | unable to provision    |               |                    |  yes         |  true               | yes                   |                      |    0.5971/hr * 8 node * ? hr= $?           | 1.944/hr * 8 node * ? hr = $? |
| 162            |  9x18          | 9x18        | unable to provision    |               |                    |  yes         |  true               | yes                   |                      |    0.5971/hr * 9 node * ? hr= $?           | 1.944/hr * 9 node * ? hr = $? |
| 180            |  10x18          | 10x18        | unable to provision              |               |                    |  yes         |  true               | yes                   |                   |    0.5971/hr * 10 node * ? hr= $?           | 1.944/hr * 10 node * ? hr = $? |
