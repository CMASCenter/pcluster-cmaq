...
|Benchmark Case |	Compute Node |	Number of PES| 	Number of Nodes	NPCOLS☓NPROWS |	Pricing	|Average| CPU-sec/day|	Compiler|	Disk|	Node cost(login +compute) $|	Time to completion (hour)|	Annual Cost	Annual Cost	Days|
|-------------  | -------------  | ------------  | -----------------------------  | ------  | ----- | ---------- |  ------  | ----- | --------------------------   | --------------------------  |  -------------------- |
