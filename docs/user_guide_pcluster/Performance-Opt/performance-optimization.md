...
|Benchmark Case |	Compute Node |	# cores | # nodes | Total Memory GiB |npcol ☓ nprow | Pricing	|Average CPU-sec/day|	Compiler|	Disk|	Node cost(login +compute) $|	Time to completion (hour)|	Annual Cost |	Annual Cost	| Days|
|-------------  | -------------  | ------------  | ------------| ----- | -------  | ------  | ----- | ---------- |  ------  | ----- | --------   | ------  |  -------------------- | -- |
|12US1 |	hpc6a.48xlarge/96cores/384GiBMem |	128	| 2	| 768 | 8x16 | ondemand	 |	2700 |	Intel (25.0.4) | 	/shared |	 $5.91 | 	0.75 |	 $1,617.86 | 	 $1,618| 	11 |
...
|12US1 |	hpc7g.16xlarge/64cores/128GiBMem |	128	| 2	| 256 |8x16	| ondemand |	2100  |	gcc (11.4.1) | 	/shared	 | $3.44  |	0.58 |	 $731.67 |	 $732 |	9 |
