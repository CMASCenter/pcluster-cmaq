...
#SBATCH --exclusive
#SBATCH -J CMAQ
#SBATCH -o /shared/build/openmpi_gcc/CMAQ_v533/CCTM/scripts/run_cctmv5.3.3_Bench_2016_12US2.hpc6a.48xlarge.576.6x96.24x24pe.2day.pcluster.fsx.pin.codemod.3.log
#SBATCH -e /shared/build/openmpi_gcc/CMAQ_v533/CCTM/scripts/run_cctmv5.3.3_Bench_2016_12US2.hpc6a.48xlarge.576.6x96.24x24pe.2day.pcluster.fsx.pin.codemod.3.log
...
echo 'slurm config file /opt/slurm/etc/cgroup.conf, to verify that ConstrainCores=yes is not commented out'
...
#> Set General Parameters for Configuring the Simulation
 ...
 set APPL      = 2016_CONUS_hpc6a.48xlarge_576_6x96_24x24pe_fsx_pin_3       #> Application Name (e.g. Gridname)
