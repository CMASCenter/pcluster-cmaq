...
#SBATCH --exclusive
#SBATCH -J CMAQ
#SBATCH -o /shared/build/openmpi_gcc/CMAQ_v533/CCTM/scripts/run_cctmv5.3.3_Bench_2016_12US2.c6a.48xlarge.192.3x64.16x12pe.2day.pcluster.pin.log
#SBATCH -e /shared/build/openmpi_gcc/CMAQ_v533/CCTM/scripts/run_cctmv5.3.3_Bench_2016_12US2.c6a.48xlarge.192.3x64.16x12pe.2day.pcluster.pin.log
...
#> Set General Parameters for Configuring the Simulation
 ...
 set APPL      = 2016_CONUS_c6a.48xlarge_192_3x64_16x12pe_pin        #> Application Name (e.g. Gridname)
...
# ===================================================================
  ...
  #  ( /usr/bin/time -p mpirun -np $NPROCS $BLD/$EXEC ) |& tee buff_${EXECUTION_ID}.txt
   (/usr/bin/time -p mpirun -np $NPROCS --bind-to l3cache --map-by ppr:16:numa -x LD_LIBRARY_PATH -x PATH -x PWD $BLD/$EXEC ) |& tee buff_${EXECUTION_ID}.txt
