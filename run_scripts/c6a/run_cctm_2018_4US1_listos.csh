...
#> Set General Parameters for Configuring the Simulation
 ...
 set APPL      = 4US1_LISTOS        #> Application Name (e.g. Gridname)
...
#> Set Start and End Days for looping
 ...
 set START_DATE = "2018-08-06"     #> beginning date (Aug 6, 2018)
 set END_DATE   = "2018-08-07"     #> ending date    (Aug 6, 2018)
...
setenv GRID_NAME 2018_4Listos     #> check GRIDDESC file for GRID_NAME options
setenv GRIDDESC $INPDIR/met/mcip/GRIDDESC   #> grid description file
...
set SZpath    = $INPDIR/surface/LISTOS4_corrected_4kmpix           #> surf zone file for in-line seaspray emissions
...
# =====================================================================
  ...
  #setenv ICFILE ICON_cb6r3_ae6_profile_12US1_timeind_m3clple_12listos.ncf
  setenv ICFILE ICON_v54_4km_Listos_regrid_$YYYYMMDD.nc
  ...
  #set BCFILE = BCON_v54_4US1_LISTOS_${YYYYMMDD}.nc
  set BCFILE = BCON_v54_4km_Listos_regrid_${YYYYMMDD}.nc
  ...
  setenv TRAINCASE  CMAS_4km_listos
...
# setenv LUFRAC_CRO  $METpath/LUFRAC_CRO.$GRID_NAME.${NZ}L.$YYMMDD
  ...
  setenv CMAQ_MASKS $SZpath/OCEAN_${MM}_L3m_MC_CHL_chlor_a_LISTOS4.nc  #> horizontal grid-dependent ocean file
  ...
  setenv N_EMIS_GR 1
  set EMISfile  = emis_mole_all_${YYYYMMDD}_4US1_LISTOS_nobeis_withrwc_2018ff_18j_WR401_fine.ncf
  setenv GR_EMIS_001 ${EMISpath}/${EMISfile}
  setenv GR_EMIS_LAB_001 GRIDDED_EMIS
  setenv GR_EM_SYM_DATE_001 F # To change default behaviour please see Users Guide for EMIS_SYM_DATE
  setenv STKDATE 20180807
  ...
  set STKCASEE = 4US1_LISTOS_cmaq_cb6_2018ff_18j_WR401_fine        # In-line Emission Rate File Suffix
  set STKCASEG = 4US1_LISTOS_2018ff_18j_WR401_fine                 # Stack parameter File Suffix
  set STKCASEE2 = 4US1_LISTOS_cmaq_cb6_2018ff_18j_WR401        # In-line Emission Rate File Suffix
  set STKCASEG2 = 4US1_LISTOS_2018ff_18j_WR401

  setenv STK_GRPS_001 $IN_PTpath/ptnonipm_nosolv_4/stack_groups_ptnonipm_nosolv_4_${STKDATE}_${STKCASEG}.ncf
  setenv STK_GRPS_002 $IN_PTpath/ptegu/stack_groups_ptegu_${STKDATE}_${STKCASEG2}.ncf
  setenv STK_GRPS_003 $IN_PTpath/pt_oilgas_nosolv/stack_groups_pt_oilgas_nosolv_${STKDATE}_${STKCASEG}.ncf
  setenv STK_GRPS_004 $IN_PTpath/cmv_c3_4/stack_groups_cmv_c3_4_${STKDATE}_${STKCASEG}.ncf
  setenv STK_GRPS_005 $IN_PTpath/cmv_c1c2_4/stack_groups_cmv_c1c2_4_${STKDATE}_${STKCASEG}.ncf

  setenv STK_EMIS_001 $IN_PTpath/ptnonipm_nosolv_4/inln_mole_ptnonipm_nosolv_4_${YYYYMMDD}_${STKCASEE}.ncf
  setenv STK_EMIS_002 $IN_PTpath/ptegu/inln_mole_ptegu_${YYYYMMDD}_${STKCASEE2}.ncf
  setenv STK_EMIS_003 $IN_PTpath/pt_oilgas_nosolv/inln_mole_pt_oilgas_nosolv_${YYYYMMDD}_${STKCASEE}.ncf
  setenv STK_EMIS_004 $IN_PTpath/cmv_c3_4/inln_mole_cmv_c3_4_${YYYYMMDD}_${STKCASEE}.ncf
  setenv STK_EMIS_005 $IN_PTpath/cmv_c1c2_4/inln_mole_cmv_c1c2_4_${YYYYMMDD}_${STKCASEE}.ncf
  ...
  setenv STK_EMIS_LAB_004 PT_CMV_C3_4
  setenv STK_EMIS_LAB_005 PT_CMV_C1C2_4
  ...
  setenv OCEAN_1 $SZpath/OCEAN_${MM}_L3m_MC_CHL_chlor_a_LISTOS4.nc
