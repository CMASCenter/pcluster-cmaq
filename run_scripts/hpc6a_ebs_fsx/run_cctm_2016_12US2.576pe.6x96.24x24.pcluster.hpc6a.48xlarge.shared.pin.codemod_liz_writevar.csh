...
#SBATCH --exclusive
#SBATCH -J CMAQ
#SBATCH -o /shared/build/openmpi_gcc/CMAQ_v533/CCTM/scripts/run_cctmv5.3.3_Bench_2016_12US2.hpc6a.48xlarge.576.6x96.24x24pe.2day.pcluster.shared.pin.codemod_liz.writevar.log
#SBATCH -e /shared/build/openmpi_gcc/CMAQ_v533/CCTM/scripts/run_cctmv5.3.3_Bench_2016_12US2.hpc6a.48xlarge.576.6x96.24x24pe.2day.pcluster.shared.pin.codemod_liz.writevar.log
...
#> Set General Parameters for Configuring the Simulation
 ...
 set APPL      = 2016_CONUS_hpc6a.48xlarge_576_6x96_24x24pe_shared_pin_codemod_liz_writevar        #> Application Name (e.g. Gridname)
...
#> is located by default).
 set BLD       = ${CMAQ_HOME}/CCTM/scripts/BLD_CCTM_${VRSN}_${compilerString}_codemod_liz
...
# ===================================================================
  ...
  #  ( /usr/bin/time -p mpirun -np $NPROCS --report-bindings $BLD/$EXEC ) |& tee buff_${EXECUTION_ID}.txt
   (/usr/bin/time -p mpirun -np $NPROCS --bind-to l3cache --map-by ppr:24:numa --report-bindings -x LD_LIBRARY_PATH -x PATH -x PWD $BLD/$EXEC ) |& tee buff_${EXECUTION_ID}.txt
  # ( /usr/bin/time -p mpirun -np $NPROCS --bind-to core --report-bindings $BLD/$EXEC ) |& tee buff_${EXECUTION_ID}.txt
