#!/bin/csh -f
## For For Cyclecloud HBV3  (120 cpu)
## data on /shared directory
#SBATCH --nodes=4
#SBATCH --ntasks-per-node=90
#SBATCH --exclusive
#SBATCH -J CMAQ
#SBATCH -o /shared/build/openmpi_gcc/CMAQ_v533/CCTM/scripts/run_cctmv5.3.3_Bench_2016_12US2.20x18pe.2day.cyclecloud.log
#SBATCH -e /shared/build/openmpi_gcc/CMAQ_v533/CCTM/scripts/run_cctmv5.3.3_Bench_2016_12US2.20x18pe.2day.cyclecloud.log
