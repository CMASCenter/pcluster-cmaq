...
### This is the configuration file that gave the fastest runtimes for the CONUS domain

```
cat /Users/lizadams/.parallelcluster/config-c5.4xlarge-nohyperthread
[aws]
...
key_name = centos
scheduler = slurm
#I don't know how to specify the bid percentage
