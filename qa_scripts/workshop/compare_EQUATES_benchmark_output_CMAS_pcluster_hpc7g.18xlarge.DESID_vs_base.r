...
output.dir <- "/shared/pcluster-cmaq/qa_scripts/qa_plots/workshop/plots"

#Directory, file name, and label for first model simulation (sim1)
sim1.label <- "CMAQv54+ 12x16 cores"
sim1.dir <- "/shared/build/openmpi_gcc/CMAQv5.4+/data/output/output_v54+_cb6r5_ae7_aq_WR413_MYR_gcc_2018_12US1_3x64_classic/"
sim1.file <- paste0(sim1.dir,"CCTM_ACONC_v54+_cb6r5_ae7_aq_WR413_MYR_gcc_2018_12US1_2x64_classic_20171222.nc")

#Directory, file name, and label for second model simulation (sim2)
sim2.label <- "CMAQv54+ 12x16 cores DESID REDUCE PT_EGU"
sim2.dir <- "/shared/build/openmpi_gcc/CMAQ_v54+/data/output/output_v54+_cb6r5_ae7_aq_WR413_MYR_gcc_2018_12US1_3x64_classic_DESID_REDUCE/"
sim2.file <- paste0(sim2.dir,"CCTM_ACONC_v54+_cb6r5_ae7_aq_WR413_MYR_gcc_2018_12US1_3x64_classic_DESID_REDUCE_20171222.nc")
