...
csv_data<-read.csv("/shared/pcluster-cmaq/docs/user_guide_pcluster/timing_c5n18xlarge.csv",sep="\t", skip =0, header = TRUE, comment.char = "",check.names = FALSE, quote="", )
print(csv_data)
...
# plot data
   png(file = paste('c5n18xlarge','_','Time','_','Cost','_','CPUs','.png',sep=''), width = 1024, height = 768, bg='white')
   x <- csv_data$CPUs
